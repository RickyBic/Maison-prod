                ...
                <div class="auto-container">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="service-block-two col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    ...
                                    <div class="text"><strong>Durée : </strong> <%=sc.getDuree()%>min.</div>
                                    <a href="${pageContext.request.contextPath}/liste_action?idScene=<%=sc.getIdScene()%>" class="read-more">Détails</a>
                                </div>
                            </div>
                        </div>
                        <%}%>
                        ...
                        <div id="myModal" class="modal">
                            <!-- Modal content -->
                            <div class="modal-content" style="position: absolute;margin-top: 5px;">
                                <span class="close">&times;</span>
                                <div class="billing-details">
                                    <div class="shop-form">
                                        <form method="get" action="${pageContext.request.contextPath}/insert_scene">
                                            <div class="row clearfix">
                                                <div class="form-group" style="text-align: center;">
                                                    <h3 style="margin-left: 170px;">Scène</h3>
                                                    <br/>
                                                    <input style="margin-left: 100px;" type="text" name="nom" placeholder="Nom scène">
                                                    <br/>
                                                    <input style="margin-left: 100px;" type="number" name="duree" placeholder="Durée">
                                                    <input type="hidden" name="idPlateau" value=<%=pl.getIdPlateau()%>>
                                                    <br/>
                        ...
                        <div class="service-block-two col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box wow fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="content"  id="myBtn">
                                    ...
                                    <h3><a href="office-interior.html">Nouvelle scène</a></h3>
                                    <div class="text">Créer une nouvelle scène pour "<strong><%=pl.getNom()%></strong>"</div>
                                </div>
                            </div>
                        </div>
